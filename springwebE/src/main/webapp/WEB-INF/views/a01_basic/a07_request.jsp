...
<div class="jumbotron text-center">
  <h2 data-toggle="modal" data-target="#exampleModalCenter">응용 get 호출</h2>
	<h1> requestexp07의 요청값! : ${param.greet}</h1>
</div>
<div class="container">
    <h2 align='center'></h2>
	<form id="frm01" class="form-inline" method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	    ...
	    <button class="btn btn-info" id="btnSub" type="submit">전달하기</button>
 	</nav>
	</form>
