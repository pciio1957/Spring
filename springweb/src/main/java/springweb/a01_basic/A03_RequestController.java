...
public class A03_RequestController {
	...
	//        requestexp01.do?name=사과&price=3000&cnt=2
	@RequestMapping("requestexp01.do")
	public String requestexp01( @RequestParam(value = "name",  
									defaultValue = "입력없음",
...
//	객체안에 setName(String name), setAge(int  age), setLoc(String loc)
//	?반드시확인 특히 객체형으로 요청값을 때, 404(페이지 못 찾음) 
//	  : 페이지명, 요청key, 매개변수의 데이터 유형
//	RequestMapping : get방식/post방식 둘다 받음.
